...
describe('must validate users entity', () => {
  it('should returns an user', () => {
    const user = {
      ...
      lastActivity: new Date(1648487089),
      isPaying: true,
      isActive: true,
      role: 'admin',
    }
  ...
  it('should returns an error if ID was not provided', () => {
    expect(() => {
      const user = {
        id: '',
        name: 'Gabriel',
  ...
  it('should returns an error if name was not provided', () => {
    expect(() => {
      const user = {
        id: '123',
        name: '',
  ...
  it('should returns an error if email was not provided', () => {
    expect(() => {
      const user = {
        id: '123',
        name: 'Gabriel',
  ...
  it('should returns an error if lastActivity was not provided', () => {
    expect(() => {
      const user = {
        id: '123',
        name: 'Gabriel',
  ...
  it('should returns an error if isPaying was not provided', () => {
    expect(() => {
      const user = {
        id: '123',
        name: 'Gabriel',
  ...
  it('should returns an error if isActive was not provided', () => {
    expect(() => {
      const user = {
        id: '123',
        name: 'Gabriel',
